...
L'esercizio per questa sezione, se fatto partire senza nessuna modifica inizialmente mostrerà a video una tabella di tutti i TCBs, questo ottenuto tramite una chiamata di sistema di debug 